...
INSERT INTO people (name, surname, patronymic, phoneNumber) VALUES ('peopleName1', 'peopleSurame1', 'peoplePatronymic1', 123456789012);
INSERT INTO people (name, surname, patronymic, phoneNumber) VALUES ('peopleNameAdmin', 'peopleSurameAdmin', 'peoplePatronymicAdmin',123456789013);
...
VALUES (nextval('global_seq'), 5, 1.1, 100004, 100019);

INSERT INTO storage_products (spid, volume, price, prodid, storageid)
VALUES (nextval('global_seq'), 1, 1.1, 100005, 100019);

INSERT INTO order_products (opid, orderid, prodid, volume, executedVolume, status) VALUES
  (nextval('global_seq'), 100012, 100005, '2', '0', '0');

-- 20

INSERT INTO orders (orderId, user_id, foruser_id, status) VALUES
  (nextval('global_seq'), 100002, 100014, '0');

INSERT INTO order_products (opid, orderid, prodid, volume, executedVolume, status) VALUES
  (nextval('global_seq'), 100023, 100005, '3', '0', '0');

INSERT INTO reserved_products (rpId, spId, opId, reserveVolume, userId) VALUES
  (nextval('global_seq'), 100020, 100013, 1, 100002);
