...
<%@ taglib prefix="myori" tagdir="/WEB-INF/tags" %>
...
<div class="jumbotron">
    <div class="container">
        ...
        <form:form modelAttribute="userTo" class="form-horizontal" method="post" action="${register ? 'register' : 'profile'}"
            ...
            <spring:message code="user.login" var="userName"/>
            <myori:inputField label='${userName}' name="name"/>

            <spring:message code="user.email" var="userEmail"/>
            <myori:inputField label='${userEmail}' name="email"/>

            <spring:message code="user.password" var="userPassword"/>
            <myori:inputField label='${userPassword}' name="password" inputType="password"/>
...
<%--        <form:form modelAttribute="people" class="form-horizontal" charset="utf-8" accept-charset="UTF-8">
